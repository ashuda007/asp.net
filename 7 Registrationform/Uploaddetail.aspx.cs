...
public partial class Uploaddetail : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("show.aspx?ug=" + DropDownList1.SelectedItem + "&pg=" + DropDownList2.SelectedItem + "&twp=" + TextBox1.Text + "&ugp=" + TextBox2.Text + "&pgp=" + TextBox3.Text + "&fn=" + f + "&padd=" + pa + "&ctr=" + co + "&sta=" + st + "&ct=" + c + "&gd=" + gd + "&hb=" + hb + "&fi=" + fi + "&fi2=" + fi2 + "&fp=" + fp);
    }
}
